...
export const SERVICE_DESCRIPTIONS: Record<ServiceSlug | 'all', ServiceDescription> = {
  ...
  weddings: {
    ...
    shortDescription: 'Cinematic wedding storytelling with timeless, emotional frames.',
    fullDescription: 'Your wedding day is a once-in-a-lifetime celebration of love, and we treat it with the reverence it deserves. Our wedding photography blends documentary-style candid moments with carefully composed portraits, creating a complete visual narrative of your special day. From the nervous excitement of getting ready to the last dance of the night, we capture every emotion, every detail, every precious moment.',
    highlights: ['8-10 Hours Coverage', '500+ Edited Photos', 'Engagement Session Included', 'Online Gallery & Print Release'],
  },
  proposals: {
    title: 'Proposal Photography',
    shortDescription: 'The yes moment captured with precision, feeling, and elegance.',
    fullDescription: 'The moment you ask the love of your life to spend forever with you deserves to be remembered forever. Our proposal photography service ensures this magical moment is captured discreetly and beautifully. We work with you to plan the perfect positioning, scout the location, and remain invisible until the perfect moment arrives. Then we capture the surprise, the emotion, and the joy in stunning detail.',
    highlights: ['2 Hours Coverage', 'Location Scouting', 'Same-Day Preview Photos', '50+ Edited Images'],
  },
  birthdays: {
    title: 'Birthday Event Photography',
    shortDescription: 'Milestones and joy documented in vibrant, story-rich detail.',
    fullDescription: 'Whether it\'s a milestone birthday, a surprise party, or an elegant celebration, our birthday event photography captures the joy, laughter, and unforgettable moments of your special day. We blend into the celebration, capturing candid moments of happiness alongside beautifully composed group shots and detail photography that preserves the atmosphere and decorations you worked so hard to create.',
    highlights: ['4-6 Hours Coverage', '200+ Edited Photos', 'Candid & Posed Shots', 'Digital Gallery Delivery'],
  },
  corporate: {
    title: 'Corporate Event Photography',
    shortDescription: 'Professional visuals for brands, teams, launches, and events.',
    fullDescription: 'First impressions matter, and professional corporate photography elevates your brand image. From product launches and conferences to team celebrations and executive portraits, we deliver polished, professional imagery that communicates your company\'s values and professionalism. Our corporate photography service provides images perfect for marketing materials, social media, annual reports, and internal communications.',
    highlights: ['Full Day Coverage', 'Professional Editing', 'Commercial Usage Rights', 'Headshots Included'],
  },
  'behind-scenes': {
    title: 'Behind the Scenes',
    shortDescription: 'A look at the creative process, team, and production craft.',
    fullDescription: 'Ever wondered what goes into creating stunning photographs? Our behind-the-scenes gallery offers a glimpse into our creative process, the equipment we use, and the dedication we bring to every shoot. From location scouting and lighting setup to the moments of creative collaboration with our clients, see the artistry and craftsmanship that transforms ordinary moments into extraordinary memories.',
    highlights: ['Professional Equipment', 'Creative Process', 'Team Collaboration', 'Production Craft'],
  },
};
