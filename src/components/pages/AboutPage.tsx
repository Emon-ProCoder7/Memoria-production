...
export default function AboutPage() {
  ...
  return (
    <div className="bg-warm-white text-charcoal">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src="https://raw.githubusercontent.com/Emon-ProCoder7/Memoria-production/refs/heads/main/memoria/resources/memoria%20watermark.jpg"
      ...
      <footer className="bg-taupe py-12">
        <div className="container mx-auto px-6">
          <div className="text-center">
            <div className="mb-8">
              <h3 className="text-3xl font-serif font-bold text-charcoal mb-4">Memoria Production</h3>
              <p className="text-charcoal/70 max-w-2xl mx-auto">
                Capturing life's most precious moments with cinematic elegance and timeless style.
                Professional photography and videography services for weddings, proposals, birthdays, and
                corporate events.
              </p>
            </div>

            <div className="flex flex-col md:flex-row justify-between gap-8 mb-8 px-4 md:px-0">
              <div className="md:text-left">
                <h4 className="font-semibold text-charcoal mb-2">Contact</h4>
                <p className="text-charcoal/70">1209 Mountain Road PL NE STE R<br />Albuquerque, NM 87110</p>
                <p className="text-charcoal/70"><a href="tel:+13239902599" className="hover:text-warm-gold">+1 (323) 990-2599</a></p>
                <p className="text-charcoal/70"><a href="mailto:info@memoriaproduction.com" className="hover:text-warm-gold">info@memoriaproduction.com</a></p>
              </div>

              <div className="md:text-right">
                <h4 className="font-semibold text-charcoal mb-2">Services</h4>
                <p className="text-charcoal/70"><a href="/services" className="hover:text-warm-gold">Wedding Photography</a></p>
                <p className="text-charcoal/70"><a href="/services" className="hover:text-warm-gold">Engagement Shoots</a></p>
                <p className="text-charcoal/70"><a href="/services" className="hover:text-warm-gold">Event Videography</a></p>
                <p className="text-charcoal/70"><a href="/services" className="hover:text-warm-gold">Corporate Branding</a></p>
              </div>
            </div>

            <div className="border-t border-charcoal/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
              <p className="text-charcoal/70">© 2026 Memoria Production LLC. All rights reserved.</p>
              <div className="flex gap-8">
                <a href="/privacy-policy" className="text-charcoal/70 hover:text-warm-gold transition-colors">Privacy Policy</a>
                <a href="/terms-and-conditions" className="text-charcoal/70 hover:text-warm-gold transition-colors">Terms of Service</a>
              </div>
            </div>
          </div>
        </div>
